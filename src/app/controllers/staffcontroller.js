...
class staffController {
    ...
    stafftable(req,res,next){
        Table.find({}).lean()
        .then((tables) => {
            res.render('staff/stafftable', { tables });
        })
        .catch((error) => {
            next(error);
        })
    ...
    staffwarehouse(req,res,next){
        Warehouse.find({}).lean()
        .then((warehouses) => {
            res.render('staff/staffwarehouse', { warehouses });
          })
        .catch((error) => {
            next(error);
        })
    ...
    create(req,res,next){
        ...
        .then(() => {
            ...
            .then(() => res.redirect('/staff/stafftable'))
            .catch((error) => {
                next(error);
            })
        })
    ...
    getOrder(req,res,next){
        ...
        .then((warehouses) => {
            ...
            .then((dish) => {
                ...
                .then((orders) => {
                    res.render('staff/staffOrderDetail',{
                      warehouses,
                      orders,
                      dish  
                    })
    ...
    confirmPay(req,res,next){
        ...
        .then(() => {
            ...
            .then((order) => {
                ...
                .then(() => res.redirect('/staff/stafforder'))
                .catch((error) => {
                    next(error);
                })
            })
